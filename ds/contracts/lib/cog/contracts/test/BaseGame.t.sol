...
contract BaseGameTest is Test {
    ...
    function setUp() public {
        ...
        BaseDispatcher d = new BaseDispatcher(address(this));
        d.registerRouter(r);
        d.registerState(state);
        state.authorizeContract(address(d.registerRule(new LogSenderRule())));
        state.authorizeContract(address(d.registerRule(new SetBytesRule())));
        state.authorizeContract(address(d.registerRule(new AnnotateNode())));
